...
class MyFrame(mainFrame1):
    ...
    def SearchCSV(self, search_texts):
        ...
        if filtered_data.empty:
            ...
            logging.error("No records found, please enter different value")
            return
        ...
        if y_axis_dialog.ShowModal() == wx.ID_OK:
            ...
            if x_axis_dialog.ShowModal() == wx.ID_OK:
                ...
                if x_axis_col is not None and y_axis_col is not None:
                    ...
                    logging.error(f"X-axis or Y-axis column not found in the grid.")
                    raise AssertionError("X-axis or Y-axis column not found in the grid.")
